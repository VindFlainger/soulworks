...
import ChatAreaList from "@/components/Chats/ChatList";
import UiAvatar from "@/components/UI/UiAvatar";
import UiContentWrapper from "@/components/UI/UiContentWrapper";

export default {
  name: "ChatView",
  components: {UiContentWrapper, UiAvatar, ChatAreaList},
  data() {
    return {
      messages: [],
      offset: 0,
  ...
  computed: {
    ...
    startLastOffset() {
      return this.$store.state.chat.chats[this.$route.params.id]?.startLastOffset || 0
    },
  },
  mixins: [requests],
  mounted() {
